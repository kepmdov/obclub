...
<%=request.getContextPath()%>/images/houseShowPic?id=<%=list.get(i).getId()%>"
            ...
            <div class="content col-lg-7">
                ...
                <ul class="list-group" style="margin-bottom:1px">
                    <li class="list-group-item">
                        <a href="house_detail.jsp?id=<%=houseInfos.get(i).getId()%>" class="row">
        ...
        <div class="btn-group col-xs-offset-5">
            <ul class="pagination">
                <li><a href="house.jsp?pageCurrent=<%=(page1.getPageCurrent()-1<= 0)?(1):(page1.getPageCurrent()-1)%>">&laquo;</a></li>
                <%for (int i = 1; i <= page1.getPageTotal(); i++) {%>
                <li><a href="house.jsp?pageCurrent=<%=i%>"><%=i%>
                </a></li>
                <%}%>
